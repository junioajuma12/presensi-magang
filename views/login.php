...
<head>
    ...
    <title>Absen Magang | Login</title>
                    ...
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/logo_bps.png') ?>" alt="Logo Indoexpress" class="img-fluid mx-auto d-block">
                                <div class="mt-3">
                                ...
                                <form action="<?= base_url('auth/login') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" id="password" class="form-control" autocomplete="current-password" placeholder="Masukan Password anda" />
                                        </div>
                                    </div>
